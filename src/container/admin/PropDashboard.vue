<template>
    <div>
        <h3>Pengaturan Dashboard Proporsional</h3>

        <!-- Filter & Tambah -->
        <n-space class="mb-3" align="center" wrap>
            <n-button type="primary" @click="openModal()">+ Tambah Grafik</n-button>
            <n-select
    ...
    <n-modal
        ...
        :title="isEditMode ? 'Edit Grafik' : 'Tambah Grafik'"
        preset="dialog"
        :style="{ width: '480px' }"
    >
        <n-form :model="formData" label-width="100">
            <n-form-item label="Nama Grafik">
                <n-input
